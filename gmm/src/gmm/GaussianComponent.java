...
public final class GaussianComponent implements XMLSerializable
{
  ...
  //fields defining the gaussian component
   ...
   * @throws IllegalArgumentException thrown if any invalid or incorrect
   *                                  settings were found
   */
   ...
   * which is only a part of the whole distribution. This is an optimized
   ...
   * <br >
   * So this is the probability of the sample under this gaussian distribution,
   * which is only a part of the whole distribution.
   *
   * @param x Matrix a sample
   * @return double the probability of this sample with respect to this
   *                distribution weighted with the prior probability of this
   ...
   * sample points and the estimates <span>p_ij = P(C=i | x_j)</span> for sample
   ...
   *                                        singular during the maximization step
   */
   ...
   *                      vector
   * @return double[] a vector, whose components are standard normal variance
   */
  ...
  /**
   * Recomputes the optimization fields. The optimization fields store values,
  ...
  private void actualizeOptimizationFields() throws CovarianceSingularityException
  {
    ...
    //root of the determinant is the product of all diagonal elements of the cholesky decomposition
