 ...
 * <br>
 * One notable aspect regarding the implementation is the fact that if
 ...
 * Algorithm with the reduced <code>PointList</code>.<br>
 * <br>
 * Another aspect of the design of this class was influenced by the limited
 * memory on real world computers. To improve performance a buffer to store some
...
public final class GaussianMixture implements XMLSerializable
{
   ...
   * The components themselves have been checked during their construction.
   *
  ...
  /**
   * Runs the EM algorithm to train this GMM given the sample points in the
  ...
  public void runEM(PointList samplePoints) throws CovarianceSingularityException
  {
    ...
    synchronized(p_ij)
    {
      ...
      //improve model until log likelihood doesn't improve significantly (change < 0,1)
      do
      {
        ...
        System.out.print("*");
        System.out.println("Log likelyhood is: "+ p);
  ...
  /**
   * This method performs the estimation step by computing the probability
  ...
  {
    List<GaussianComponent> componentList = new LinkedList<GaussianComponent>();
